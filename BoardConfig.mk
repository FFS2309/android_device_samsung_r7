...
# Kernel
TARGET_PREBUILT_KERNEL := device/samsung/r7/prebuilt/Image
TARGET_PREBUILT_DTB := device/samsung/r7/prebuilt/dtb
BOARD_PREBUILT_DTBOIMAGE := device/samsung/r7/prebuilt/recoverydtbo
...
BOARD_KERNEL_CMDLINE := androidboot.hardware=exynos9810 androidboot.selinux=permissive
...
BOARD_MKBOOTIMG_ARGS += --header_version $(BOARD_BOOT_HEADER_VERSION) --pagesize $(BOARD_KERNEL_PAGESIZE) --board "SRPSI06A007"
BOARD_MKBOOTIMG_ARGS += --dtb $(TARGET_PREBUILT_DTB) --dtb_offset $(BOARD_DTB_OFFSET)
BOARD_CUSTOM_BOOTIMG_MK := device/samsung/r7/bootimg.mk
...
BOARD_SAMSUNG_DYNAMIC_PARTITIONS_SIZE := 7732199424
